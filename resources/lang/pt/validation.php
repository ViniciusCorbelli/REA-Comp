...
return [
    ...
    */
    ...
    | especificar uma linha de idioma personalizada específica para uma regra de atributo dada.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de idioma são usadas para substituir nossos marcadores de atributo
    | por algo mais amigável, como "Endereço de E-mail" em vez de "email". Isso ajuda a tornar nossa mensagem mais expressiva.
    |
    */

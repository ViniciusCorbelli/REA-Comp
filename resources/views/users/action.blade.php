<div class="flex align-items-center list-user-action">
    ...
    ?>
    <a class="btn btn-sm btn-icon btn-danger" onclick="return confirm('{{$message}}') ? document.getElementById('user-delete-{{$id}}').submit() : false" data-bs-toggle="tooltip" title="Delete User" href="javascript:void(0)">
        <span class="btn-inner">

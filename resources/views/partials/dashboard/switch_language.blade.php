        ...
        <div class="m-0 border-0 shadow-none card">
            <div class="p-0 ">
                <ul class="p-0 list-group list-group-flush">
                    <li class="iq-sub-card list-group-item" onclick="languageSwitch('pt')"><a class="p-0"><img
                    ...
                    <li class="iq-sub-card list-group-item" onclick="languageSwitch('en')"><a class="p-0"><img

<x-guest-layout>
    <div class="container-fluid p-0">
        <div class="iq-maintenance text-center">
            <img src="{{ asset('images/error/01.png') }}" class="img-fluid mb-4">
                ...
                <div class="bg-primary" style="background: transparent; height: 320px;">
                    <div class="gradient-bottom">
                        <div class="bottom-text general-zindex">
                            <h1 class="mb-2 text-white"> Ocorreu um erro interno</h1>
                            <p>Nossa equipe foi notificada e estamos trabalhando para normalizar o problemas.</p>
                            <a class="btn bg-white text-primary d-inline-flex align-items-center" href="/">Ir para
                                a página inicial</a>
                        </div>
